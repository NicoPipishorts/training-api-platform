 ...
 */
final class Version20221109150116 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE wine_caract (id INT AUTO_INCREMENT NOT NULL, fruite SMALLINT NOT NULL, mineral SMALLINT NOT NULL, epice SMALLINT NOT NULL, puissance SMALLINT NOT NULL, floral SMALLINT NOT NULL, boise SMALLINT NOT NULL, acidite SMALLINT NOT NULL, datemodified DATETIME NOT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('DROP TABLE wine_caract');
